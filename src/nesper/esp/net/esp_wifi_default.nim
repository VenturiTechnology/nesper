...
proc esp_netif_attach_wifi_station*(esp_netif: ptr esp_netif_t): esp_err_t {.
    importc: "esp_netif_attach_wifi_station", header: thdr.}
##
...
proc esp_netif_attach_wifi_ap*(esp_netif: ptr esp_netif_t): esp_err_t {.
    importc: "esp_netif_attach_wifi_ap", header: thdr.}
##
...
proc esp_wifi_set_default_wifi_sta_handlers*(): esp_err_t {.
...
proc esp_wifi_set_default_wifi_ap_handlers*(): esp_err_t {.
    importc: "esp_wifi_set_default_wifi_ap_handlers", header: thdr.}
##
...
proc esp_wifi_set_default_wifi_nan_handlers*(): esp_err_t {.
...
proc esp_wifi_clear_default_wifi_driver_and_handlers*(esp_netif: pointer): esp_err_t {.
    importc: "esp_wifi_clear_default_wifi_driver_and_handlers",
    header: thdr.}
##
...
proc esp_netif_create_default_wifi_ap*(): ptr esp_netif_t {.
    importc: "esp_netif_create_default_wifi_ap", header: thdr.}
##
...
proc esp_netif_create_default_wifi_sta*(): ptr esp_netif_t {.
    importc: "esp_netif_create_default_wifi_sta", header: thdr.}
##
...
proc esp_netif_create_default_wifi_nan*(): ptr esp_netif_t {.
    importc: "esp_netif_create_default_wifi_nan", header: thdr.}
##
...
proc esp_netif_destroy_default_wifi*(esp_netif: pointer) {.
    importc: "esp_netif_destroy_default_wifi", header: thdr.}
##
...
proc esp_netif_create_wifi*(wifi_if: wifi_interface_t;
    ...
    importc: "esp_netif_create_wifi", header: thdr.}
##
...
proc esp_netif_create_default_wifi_mesh_netifs*(p_netif_sta: ptr ptr esp_netif_t;
    p_netif_ap: ptr ptr esp_netif_t): esp_err_t {.
    importc: "esp_netif_create_default_wifi_mesh_netifs",
    header: thdr.}
